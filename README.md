...
## **Project Information**
YouBudget is a budgeting app that allows users to track their income and expenses to get the status of their finances and view a table summarizing their transactions monthly. The user can add rows to an "Income" and "Expenses" table to input the month, type, and total amount associated with each transaction. When the user clicks the "Submit" button at the bottom of the page, a financial summary appears with their total income and expenses, a status message based on an income-to-expense ratio, and a bar graph displaying their monthly transactions.
...
```bash
git clone https://github.com/OntarioTech-CS-program/w24-csci2020u-final-project-lofters-purai-osman-daniel.git
```
### Step 2:
...
- The "Income" and "Expenses" table inputs include a month, type, total amount of a transaction, and button to remove a row.
...
- Jonathan Purai - 25%
- Meron Daniel - 25%
- Abdellatif Osman - 25% <br>

Each group member contributed their thoughts and ideas towards the project and contributed to the GitHub repository.
